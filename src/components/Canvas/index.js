...
class Canvas extends Component {
  ...
  snakeThread = () => {
    ...
    if (snakeDirection === 'left') {
      snakeArray.unshift({x: xTmp - MOVE_PX, y: yTmp, style: 'headleft'})
    } else if (snakeDirection === 'up') {
      snakeArray.unshift({x: xTmp, y: yTmp - MOVE_PX, style: 'headup'})
    } else if (snakeDirection === 'right') {
      snakeArray.unshift({x: xTmp + MOVE_PX, y: yTmp, style: 'headright'})
    } else if (snakeDirection === 'down') {
      snakeArray.unshift({x: xTmp, y: yTmp + MOVE_PX, style: 'headdown'})
    }
